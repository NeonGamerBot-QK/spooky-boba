if(!sessionStorage.getItem('allowed_approval')) window.location.href = '/beforeuenterthescary.html';

;(() => {
    let last_click = null
    const bgMusic = new Audio("./assets/audios/music.mp3", { loop: true, volume: 0.2})
    bgMusic.volume = 0.05
    bgMusic.loop = true
