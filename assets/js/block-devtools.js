!(function (e, t) {
  ...
  function q(e) {
    ...
    for (t in d) {
      var i = t;
      void 0 === n[i] ||
        (o(d[i]) !== o(n[i]) && -1 === U.indexOf(i)) ||
        (d[i] = n[i]);
    }
    "function" == typeof d.ondevtoolclose &&
      !0 === d.clearIntervalWhenDevOpenTrigger &&
      ((d.clearIntervalWhenDevOpenTrigger = !1),
      console.warn(
  ...
  function G() {
    for (var e in S) if (S[e]) return (D = !0);
    return (D = !1);
  }
  ...
  var k = (function () {
      function n(e) {
        ...
        i(this, n),
          ...
          (this.type = t),
          (this.enabled = e),
          this.enabled && ((t = this), Z.push(t), this.init());
      }
      return (
        u(n, [
          {
    ...
    Y = (function () {
      ...
      var e = l(t);
      function t() {
        return i(this, t), e.call(this, { type: O.DebugLib });
      }
      return (
        u(
          t,
  ...
  function te(o) {
    ...
    B(e, t),
      (n = t),
      (i = e),
      void 0 !== (a = document).hidden
        ? ((r = "hidden"), (c = "visibilitychange"), (u = "visibilityState"))
        : void 0 !== a.mozHidden
          ? ((r = "mozHidden"),
  ...
  var _ = (function () {
    ...
    oe = (function () {
      ...
      var e = l(t);
      function t() {
        return i(this, t), e.call(this, { type: O.DefineId });
      }
      return (
        u(t, [
          {
    ...
    re = (function () {
      ...
      function t() {
        return (
          i(this, t),
          e.call(this, { type: O.Size, enabled: !p.iframe && !p.edge })
        );
      }
      return (
        u(t, [
  ...
  var A,
    ...
    le = (function () {
      ...
      function t() {
        return (
          i(this, t),
          e.call(this, { type: O.Debugger, enabled: p.iosChrome || p.iosEdge })
        );
      }
      return (
        u(t, [
    ...
    fe = (function () {
      ...
      function t() {
        return (
          i(this, t),
          e.call(this, { type: O.Performance, enabled: p.chrome || !p.mobile })
        );
      }
      return (
        u(t, [
  ...
  var R = Object.assign(
    function (e) {
      ...
      return (
        ("all" === d.detectors ? Object.keys(se) : d.detectors).forEach(
          function (e) {
            new se[e]();
          },
        ),
